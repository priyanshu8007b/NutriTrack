...
import { Lightbulb, CheckCircle2, Leaf, Info, Utensils } from "lucide-react"
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      <header>
        ...
        <p className="text-muted-foreground mt-2 text-lg">Essential guidance for a balanced Indian lifestyle.</p>
      </header>
